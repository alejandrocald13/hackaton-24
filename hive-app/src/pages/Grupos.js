...
function Grupos() {
  ...
  const fetchGrupos = async () => {
    ...
    const response = await fetch('https://localhost:3001/api/fetch-groups', {
      method: 'POST',
  ...
  const linkPeople = async () => {
    ...
    const response = await fetch('https://localhost:3001/api/linkPeople', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const agregarGrupo = async () => {
    ...
    try {
      const response = await fetch("https://localhost:3001/api/registerGroup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
